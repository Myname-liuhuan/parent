...
public class AliyunSmsUtil {
    ...
    public static String sendSms(String Numbers,String code) throws ClientException {
        ...
        request.setPhoneNumbers(Numbers);  //必填:待发送手机号13297202906
        request.setSignName("ahuan商城");//必填:短信签名-可在短信控制台中找到  需要替换
        request.setTemplateCode("SMS_180057875"); //必填:短信模板-可在短信控制台中找到  需要替换
        ...
        String sendIsOk = sendSmsResponse.getCode();
        return sendIsOk;
    }
    public static void main(String[] args) throws ClientException, InterruptedException {
        //发短信
        String sendIsOk = sendSms("13297202906","168168");
        if(sendIsOk.equals("OK")){
