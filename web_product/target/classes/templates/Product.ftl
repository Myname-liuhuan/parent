...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="localhost:8084/webusers/toLogin" id="titleUser">登录</a>&nbsp; <a href="localhost:8084/webusers/toReg" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    ...
    <div class="i_car">
    	<div class="car_t">购物车 [ <span id="goodsNum"></span> ]</div>
        <div class="car_bg">
       		<!--Begin 购物车未登录 Begin-->
        	<div class="un_login" id="buyCarDiv">还未登录！<a href="Login.html" style="color:#ff4e00;">马上登录</a> 查看购物车！</div>
            <!--End 购物车未登录 End-->
            <!--Begin 购物车已登录 Begin-->
            <ul class="cars" id="showBuyCarUl">

            </ul>
            <div class="price_sum">共计&nbsp; <font color="#ff4e00">￥</font><span id="zprice">0.0</span></div>
...
<div class="i_bg">
    ...
    <div class="content">
        <input type="hidden" id="goodIdInput" value="${goodId}"/>
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="${href}" title="Images" class="MagicZoom" id="MagicZoom"><img src="${avatorimg}" width="390" height="390" /></a></div>
            <div id="tsPicContainer">
                <div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
                <div id="tsImgSCon">
                    <ul>
                        <#list imgUrlList as temp>
                            <li onclick="showPic(${temp_index})" rel="MagicZoom">
                                <img src="${temp}" tsImgS="${temp}" width="79" height="79" />
                            </li>
                        </#list>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
            	本店价格：<b>￥${price?string("0.00")}</b><br />
            </div>
            <div class="des_choice">
            	<span class="fl">型号选择：</span>
                <ul>
                	<li class="checked">${type}<div class="ch_img"></div></li>
                </ul>
            </div>
            <div class="des_choice">
            	<span class="fl">颜色选择：</span>
                <ul>
                	<li>${color}<div class="ch_img"></div></li>
                </ul>
            </div>
            <div class="des_choice">
                <span class="fl">库存量：${num}个</span>
            </div>
            <div class="des_share">
            	<div class="d_sh">
                	分享
            ...
            <div class="des_join">
            	<div class="j_nums">
                	<input type="text" value="1" id="goodNum" name="" class="n_ipt" />
                    <input type="button" value="" onclick="addUpdate(jq(this));" class="n_btn_1" />
                    <input type="button" value="" onclick="jianUpdate(jq(this));" class="n_btn_2" />   
                </div>
                <span class="fl"><li id="addBuyCarBtn"><img src="images/j_car.png" /></li></span>
            </div>            
        </div>    
            ...
            <div class="des_border">
                <div class="des_tit">
                	<ul>
                        ...
                        <li id="discuss"><a href="#p_comment">商品评论</a></li>
                    </ul>
                </div>
    ...
    <div id="MyDiv1" class="white_content">             
        <div class="white_d">
            <div class="notice_t">
                <span class="fr" style="margin-top:10px; cursor:pointer;"><img src="images/close.gif" /></span>
            </div>
            <div class="notice_c">
...
<script type="text/javascript">
    jQuery(function () {
        jQuery("#discuss").click(function () {
            console.log("点击了 商品评论栏 。。。")
            jQuery.ajax({
                type:'POST',
                url:'http://localhost:8091/discuss/loadDiscuss',
                dataType:'JSON',
                data:{'page':1,"limit":5},
                success:function (rs) {
                    console.log(rs);
                    ...
                    for(var i in rs){
                        content+="<tr valign=\"top\">\n" +
                                "<td width=\"160\"><img src='"+rs[i].userImg+"' width=\"20\" height=\"20\" align=\"absmiddle\" />&nbsp;"+rs[i].userName+"</td>\n" +
                                "<td width=\"180\">\n" +
                                "\t颜色分类：<font color=\"#999999\">"+rs[i].color+"</font> <br />\n" +
                                "\t型号：<font color=\"#999999\">"+rs[i].type+"</font>\n" +
                                "</td>\n" +
                                "<td>\n" +
                                "\t"+rs[i].content+"<br />\n" +
                                "\t<font color=\"#999999\">"+rs[i].dateTime+"</font>\n" +
                                "</td>\n" +
                                "</tr>"
                    }
        ...
        //添加购物车
        jQuery("#addBuyCarBtn").click(function () {
            jQuery.ajax({
                type:'post',
                url:'http://localhost:8089/buyCar/addBuyCar',
                xhrFields:{withCredentials:true},
                data:{"goodId":jQuery("#goodIdInput").val(),"num":jQuery("#goodNum").val(),"uid":uid},
                ...
                error:function () {
                    alert("操作异常！！！",{"icon":3,anim:6,shade:0.6,"time":2000});
                }
            });
        });
        ...
        function loadBuyCar(){
            jQuery.ajax({
                type:'post',
                url:'http://localhost:8089/buyCar/loadBuyCar/',
                data:{"uid":uid},
                xhrFields:{withCredentials:true},
                success:function (data) {
                    if(data!=''){
                        jQuery("#goodsNum").text(data.goods.length);
                        var zprice = 0.0;
                        var buyCarUlStr = '';
                        jQuery.each(data.goods,function (i,good) {
        ...
        //加载8084登录模块中的session中的用户数据
        function loadWebLoginUser(){
            jQuery.ajax({
                type:'post',
                url:'http://localhost:8084/webusers/loadWebLoginUser',
                async:false,
                xhrFields:{withCredentials:true},
                success:function (data) {
                    if(data!=''){
                        uid = data.id;
                        jQuery("#buyCarDiv").replaceWith('<div class="un_login" id="buyCarDiv">已登录。。<font color="red">'+data.uname+'</font>查看购物车！</div>')
                        jQuery("#titleUser").replaceWith('<a href="localhost:8084/webusers/exitUser" id="titleUser"><font color="red">'+data.uname+'</font>注销</a>');
                    }
                },
                error:function () {
                    layer.msg("操作异常！！！",{"icon":3,anim:6,shade:0.6,"time":2000});
